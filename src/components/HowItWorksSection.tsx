      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mt-16">
          {steps.map((step) => (
            <div
              key={step.number}
              className="bg-white/5 border border-white/10 backdrop-blur-xl rounded-3xl p-8 hover:border-blue-500/40 transition"
            >
              <span className="text-blue-400 text-5xl font-bold">
                {step.number}
              </span>
